...
** If that is confusing then simply think of the Upload folder as your forum root directory and the content with the Upload folder are already in correct structure so just follow that and simply upload the contents inside the upload folder to your forum root directory ie: /upload/ = /forumroot/
...
5/10/2020 - minor changes to get it to install and work on mybb 1.8 default theme and mybb 1.8 by: vintagedaddyo
